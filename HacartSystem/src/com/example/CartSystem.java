...
public class CartSystem extends TheSystem {
    ...
    public void display() {
        ...
        DecimalFormat decinum = new DecimalFormat("#0.00");
        ...
        for (String name : hm.keySet()) {
            ...
            String myItemPrice = decinum.format(myItem.getItemPrice());
            ...
            String myItemFormatedOverallPrice = String.format("%-10s", decinum.format(myItemOverallPrice));
        ...
        System.out.println(" " + String.format("%-20s", decinum.format(sumSubTotal)));
        System.out.print(String.format("%-20s", "Tax"));
        System.out.println(String.format(" " + "%-20s", decinum.format(tax)));
        System.out.print(String.format("%-20s", "Total"));
        System.out.println(String.format(" " + "%-20s", decinum.format(total)));
    }
}